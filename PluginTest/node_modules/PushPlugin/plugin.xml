...
<plugin id="com.duoxieyun.pshplugin" version="0.0.1" xmlns:cdv="http://apache.org/cordova/ns/plugins/1.0" 
    ...
    <platform name="android">
    	  <source-file src="src/android/libs" target-dir="src/com/duoxieyun/" />
    	  ...
    	  <source-file src="src/android/Push.java" target-dir="src/com/duoxieyun/" />
    	  <source-file src="src/android/DXReceiver.java" target-dir="src/com/duoxieyun/" />
    	  <source-file src="src/android/DXApplication.java" target-dir="src/com/duoxieyun/" />
	      <config-file target="res/xml/config.xml" parent="/*">  
	          <feature name="Push">  
	              <param name="android-package" value="com.duoxieyun.Push"/>  
	          </feature>  
	      </config-file> 
         ...
         <config-file target="AndroidManifest.xml" parent="/manifest/application">  
			...
			<!--消息接收监听器-->
			<receiver android:name="com.duoxieyun.DXReceiver">
			    <intent-filter>
         ...
         <edit-config file="AndroidManifest.xml" target="/manifest/application" mode="merge">
	        ...
	        android:supportsRtl="true" android:name="com.duoxieyun.DXApplication"/>
	    </edit-config>
    ...
    <platform name="ios">
    	...
    	<config-file target="res/xml/config.xml" parent="/*">  
	        <feature name="Push">  
	            <param name="ios-package" value="com.duoxieyun.Push"/>  
	        </feature>  
	    </config-file> 
